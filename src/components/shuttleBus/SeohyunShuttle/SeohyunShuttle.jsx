...
const SeohyunShuttle = () => (
  <div style={{display: 'flex', 'flexDirection': 'column'}}>
    <table style={{border: '1px solid'}}>
      <tr>
        <td style={{ textAlign: 'center' }} colSpan={colSpan}>{'서현 출근 버스'}</td>
      </tr>
      <tr>
        <th>서현역공항버스</th>
        <th>낙생육교</th>
      ...
      <tr>
        <td style={{ textAlign: 'center' }}>07:30</td>
        <td style={{ textAlign: 'center' }}>07:40</td>
        <td style={{ textAlign: 'center' }}>07:43</td>
      </tr>
      <tr>
        <td style={{ textAlign: 'center' }}>08:10</td>
        <td style={{ textAlign: 'center' }}>08:20</td>
        <td style={{ textAlign: 'center' }}>08:23</td>
      </tr>
    </table>
    <table style={{border: '1px solid'}}>
      <tr>
        <td style={{ textAlign: 'center' }} colSpan={3}>{'서현 퇴근 버스'}</td>
      </tr>
      <tr>
        <th>SK케미칼 앞</th>
      </tr>
      <tr>
        ...
        <td style={{ textAlign: 'center' }}>판교역</td>
        <td style={{ textAlign: 'center' }}>서현역</td>
      </tr>
      <tr>
      ...
      <tr>
        <td style={{ textAlign: 'center' }}>19:00</td>
        <td style={{ textAlign: 'center' }}>판교역</td>
      </tr>
      <tr>
